...
class SettingViewController: BaseViewController<SettingViewModel>, SideMenuItemContent {
    ...
    lazy var tableView: SettingViewTableView = {
        let tableView = SettingViewTableView(frame: .zero, style: .grouped)
...
class SettingViewTableView: BaseTableView, UITableViewDataSource, UITableViewDelegate {
    
    weak var controller: SettingViewController!
    ...
    override func setUpViews() {
        ...
        register(SettingViewTableCell.self)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusable(at: indexPath) as SettingViewTableCell
        return cell
    }
